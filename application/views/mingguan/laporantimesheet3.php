    ...
    <div class="section-body">
      ...
      <div class="row">
        <div class="card">
          <div class="card-header">
            <div class="col-10">
              Laporan Timesheet <?php echo date('d-m-Y', strtotime($tglterakhir['daritanggal'])) ?> s/d <?php echo date('d-m-Y', strtotime($tglterakhir['sampaitanggal'])) ?>
            </div>
            <div class="col-2 text-right">
              <a href="<?= base_url('mingguan/printLaporanHarian/') ?><?= "$daritanggal/$sampaitanggal"; ?>" target="_blank" type="button" class="btn btn-primary">Print</a>
            </div>
          </div>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a tabindex="0" class="btn" role="button" data-html="true" data-toggle="popover" data-trigger="focus" title="Daftar SDSD" data-content="
                        ...
                        <td>
                          ...
                          <a tabindex="0" class="btn" role="button" data-html="true" data-toggle="popover" data-trigger="focus" title="Daftar Cuti" data-content="<?php foreach ($caricuti as $ct) {
                                                                                                                                                                    echo "<table class='bordered'>";
                                                                                                                                                                    echo "<tr>";
                                                                                                                                                                    echo "<td>";
                                                                                                                                                                    echo $ct['tanggal'];
                        ...
                        <td>
                          ...
                          <a tabindex="0" class="btn" role="button" data-html="true" data-toggle="popover" data-trigger="focus" title="Libur Nasional" data-content="
                                         <?php foreach ($hariLibur as $cabur) {
                                            echo "<table class='bordered'>";
                                            echo "<tr>";
                                            echo "<td>";
                                            echo $cabur['tanggal'];
