  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Approval Target Kerja 3</div>
      </div>
    </div>
          ...
          <div class="col-sm-12">
              <div class="card">
                <div class="card-header">
                  <h4>Target Kerja <?php echo $key['divisi']?> (<?php echo $key['namapengisi']?>) <?php echo date('d-m-Y', strtotime($key['daritanggal']))?> s/d <?php echo date('d-m-Y', strtotime($key['sampaitanggal']))?> <?php echo $tambahan ?></h4>
                  <div class="card-header-action">

                    <div class="dropdown">
                      <a href="#" data-toggle="dropdown" class="btn btn-warning dropdown-toggle">Options</a>
                      <div class="dropdown-menu">
                        <a href="<?=base_url('mingguan/tambahtkmdiv/')?><?php echo $key['no']?>" class="dropdown-item has-icon"><i class="fas fa-plus"></i> Add Target Kerja</a>
                        <a href="<?=base_url('mingguan/edittkmmanager/')?><?php echo $key['no']?>" class="dropdown-item has-icon"><i class="far fa-edit"></i> Edit</a>
                ...
                <div class="collapse show" id="mycard-collapse<?php echo $key['no']?>">
                  <div class="card-body">
                          ...
                          <tbody>
                              ...
                              ?>
                                  ...
                                  <tr>
                                      ...
                                      <td><?php echo date('d-m-Y', strtotime($ua['targetselesai']))?></td>
...
<div class="modal fade" tabindex="-1" role="dialog" id="hapus">
          <div class="modal-dialog modal-lg" role="document">
            ...
            <form action="<?=base_url('mingguan/hapussemuadata3')?>" method="post">
